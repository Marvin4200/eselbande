@echo off
rem Baut den Inno-Setup-Installer neu, legt ihn als EselShot-Setup.exe in filehoster\downloads
...
copy /Y "dist\EselShot-Setup-%VERSION%.exe" "..\filehoster\downloads\EselShot-Setup.exe" || goto :err
